...
public class npcsentado1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) && informacion == false && jugadorcerca1 == true)
        {
            ...
            texto1.text = "buen dia, digame señor necesita algo??";
        ...
        {
            texto1.text = "Sí, he oído hablar de eso. Parece que ha habido problemas con algunas guayabas que se han vendido últimamente. Por lo que he escuchado, algunas de esas guayabas tenían manchas extrañas y una especie de textura pegajosa en la piel. No sé mucho más al respecto, pero suena como algo que debería ser investigado, ¿verdad?\r\n\r\n";
