...
public class npcpolice : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) && informacion == false && jugadorcerca1 == true)
        {
            ...
            texto1.text = "buen dia, que se le ofrece?";
        ...
        {
            texto1.text = "Las guayabas que compré recientemente tenían un aspecto un tanto arrugado y algunas partes estaban blandas al tacto. Además, noté que tenían un olor un poco ácido, diferente al usual de las guayabas frescas. Sin embargo, al cortarlas, encontré que la pulpa tenía zonas de color oscuro y una consistencia más suave de lo normal. Fue bastante extraño.";
